...
class Form::AdminSettings
  ...
  KEYS = %i(
    ...
    wrapstodon
    email_footer_text
    social_classic_light_theme_color
    social_classic_dark_theme_color
    social_classic_light_logo
    social_classic_dark_logo
    social_classic_light_background
    social_classic_dark_background
  ).freeze
  ...
  validates :social_classic_light_theme_color, :social_classic_dark_theme_color, format: { with: /\A#[0-9a-f]{6}\z/i }, if: -> { defined?(@social_classic_light_theme_color) || defined?(@social_classic_dark_theme_color) }
