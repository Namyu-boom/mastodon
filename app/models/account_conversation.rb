...
class AccountConversation < ApplicationRecord
  ...
  def participant_accounts
    @participant_accounts ||= if conversation.conversation_memberships.active.exists?
                                conversation.active_member_accounts.where.not(id: account_id).to_a
                              else
                                Account.where(id: participant_account_ids).to_a
                              end
