...
export interface ApiStatusAutomationChoiceJSON {
  id: string;
  label: string;
  position: number;
...
export interface ApiStatusAutomationCardJSON {
  id: string;
  prompt: string;
  selected: boolean;
  selectable: boolean;
  choices: ApiStatusAutomationChoiceJSON[];
}
...
export interface ApiStatusJSON {
  ...
  automation_card?: ApiStatusAutomationCardJSON;
}
