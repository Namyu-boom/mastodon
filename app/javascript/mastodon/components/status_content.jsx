...
import { StatusAutomationCard } from 'mastodon/components/status_automation_card';
...
class StatusContent extends PureComponent {
  ...
  render () {
    ...
    const automationCard = status.get('automation_card') && (
      <StatusAutomationCard statusId={status.get('id')} card={status.get('automation_card')} />
    );
