...
export function ConversationDetail() {
  return import('../../conversation_detail');
}

export function NewConversation() {
  return import('../../new_conversation');
}

export function AdminConversations() {
  return import('../../admin_conversations');
}

export function AdminConversationDetail() {
  return import('../../admin_conversation_detail');
}

export function ConversationAutomation() {
  return import('../../conversation_automation');
}
