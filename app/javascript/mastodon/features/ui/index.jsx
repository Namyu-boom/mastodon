      ...
      <ColumnsContextProvider multiColumn={!singleColumn}>
        <ColumnsArea ref={this.setRef} singleColumn={singleColumn} domain={domain} minimalShell={minimalShell}>
          <WrappedSwitch>
            ...
            <WrappedRoute path='/conversations/admin/:id' component={AdminConversationDetail} content={children} />
            <WrappedRoute path='/conversations/admin' exact component={AdminConversations} content={children} />
            <WrappedRoute path='/conversations/automation' exact component={ConversationAutomation} content={children} />
            <WrappedRoute path='/conversations/new' exact component={NewConversation} content={children} />
            <WrappedRoute path='/conversations/:id' component={ConversationDetail} content={children} />
            <WrappedRoute path={['/conversations', '/timelines/direct']} exact component={DirectTimeline} content={children} />
