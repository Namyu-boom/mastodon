...
ActiveRecord::Schema[8.1].define(version: 2026_09_16_003000) do
  ...
  create_table "conversation_automation_choices", force: :cascade do |t|
    t.bigint "conversation_automation_rule_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "conversation_automation_executions", force: :cascade do |t|
    t.bigint "conversation_automation_choice_id"
    t.bigint "conversation_automation_rule_id", null: false
    t.bigint "conversation_id", null: false
    t.datetime "created_at", null: false
    t.bigint "response_status_id"
    t.bigint "selected_by_account_id", null: false
    t.datetime "updated_at", null: false
    t.index ["conversation_automation_choice_id"], name: "index_conversation_automation_executions_on_choice_id"
    t.index ["conversation_id", "conversation_automation_rule_id", "selected_by_account_id"], name: "index_conversation_automation_executions_once_per_rule", unique: true
    t.index ["response_status_id"], name: "index_conversation_automation_executions_on_response_status_id"
  end

  create_table "conversation_automation_rules", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.boolean "active", default: true, null: false
    t.datetime "created_at", null: false
    t.string "default_image_url"
    t.text "default_response_text"
    t.boolean "match_in_text", default: false, null: false
    t.string "name", null: false
    t.text "prompt", null: false
    t.string "trigger_keyword", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_conversation_automation_rules_on_account_id"
  end
  ...
  create_table "status_automation_cards", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "prompt", null: false
    t.bigint "source_rule_id"
    t.bigint "status_id", null: false
    t.datetime "updated_at", null: false
    t.index ["source_rule_id"], name: "index_status_automation_cards_on_source_rule_id"
    t.index ["status_id"], name: "index_status_automation_cards_on_status_id", unique: true
  end

  create_table "status_automation_choices", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "image_url"
    t.string "label", null: false
    t.integer "position", default: 0, null: false
    t.text "response_text", null: false
    t.bigint "status_automation_card_id", null: false
    t.datetime "updated_at", null: false
    t.index ["status_automation_card_id", "position"], name: "index_status_automation_choices_on_card_and_position"
  end

  create_table "status_automation_executions", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "response_status_id"
    t.bigint "selected_by_account_id", null: false
    t.bigint "status_automation_card_id", null: false
    t.bigint "status_automation_choice_id", null: false
    t.datetime "updated_at", null: false
    t.index ["response_status_id"], name: "index_status_automation_executions_on_response_status_id"
    t.index ["status_automation_card_id", "selected_by_account_id"], name: "index_status_automation_executions_once_per_account", unique: true
  ...
  add_foreign_key "conversation_automation_choices", "conversation_automation_rules", on_delete: :cascade
  add_foreign_key "conversation_automation_executions", "accounts", column: "selected_by_account_id", on_delete: :cascade
  add_foreign_key "conversation_automation_executions", "conversation_automation_choices", on_delete: :cascade
  add_foreign_key "conversation_automation_executions", "conversation_automation_rules", on_delete: :cascade
  add_foreign_key "conversation_automation_executions", "conversations", on_delete: :cascade
  add_foreign_key "conversation_automation_executions", "statuses", column: "response_status_id", on_delete: :nullify
  add_foreign_key "conversation_automation_rules", "accounts", on_delete: :cascade
  ...
  add_foreign_key "status_automation_cards", "conversation_automation_rules", column: "source_rule_id", on_delete: :nullify
  add_foreign_key "status_automation_cards", "statuses", on_delete: :cascade
  add_foreign_key "status_automation_choices", "status_automation_cards", on_delete: :cascade
  add_foreign_key "status_automation_executions", "accounts", column: "selected_by_account_id", on_delete: :cascade
  add_foreign_key "status_automation_executions", "status_automation_cards", on_delete: :cascade
  add_foreign_key "status_automation_executions", "status_automation_choices", on_delete: :cascade
  add_foreign_key "status_automation_executions", "statuses", column: "response_status_id", on_delete: :nullify
