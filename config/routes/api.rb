  ...
  namespace :v1 do
    resources :statuses, only: [:index, :create, :show, :update, :destroy] do
      scope module: :statuses do
        ...
        post 'automation_choices/:choice_id', to: 'automation_choices#create'
    ...
    resources :conversations, only: [:index, :show, :create, :update, :destroy] do
      member do
        ...
        delete :leave
        get :info
        get :automation_choices
        post 'automation_choices/:choice_id', action: :select_automation_choice, as: :select_automation_choice
      end
    end

    resources :conversation_automation_rules, only: [:index, :show, :create, :update, :destroy]
